...
complete -c ec_probe -r -n '__fish_seen_subcommand_from read && test (__fish_number_of_cmd_args_wo_opts) = 2' -d 'Register source' -f -a '(seq 0 255)'
# command write
...
complete -c ec_probe -r -n '__fish_seen_subcommand_from write && test (__fish_number_of_cmd_args_wo_opts) = 2' -d 'Register destination' -f -a '(seq 0 255)'
complete -c ec_probe -r -n '__fish_seen_subcommand_from write && test (__fish_number_of_cmd_args_wo_opts) = 3' -d 'Value to write' -f -a '(seq 0 255)'
# command monitor
